...
declare function getFlatStyle(style: any, blurRadius: any, filterId: any, tintColorProp: any): any;
...
const Image: React.AbstractComponent<ImageProps, React.ElementRef<typeof View>> = React.forwardRef((props, ref) => {
  ...
  const [flatStyle, _resizeMode, filter, _tintColor] = getFlatStyle(style, blurRadius, filterRef.current, props.tintColor);
